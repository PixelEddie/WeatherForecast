let cityInput = document.getElementById("city_input"),
  ...
  locationBtn = document.getElementById("locationBtn"), // ✅ ADDED THIS LINE
...
function getWeatherDetails(name, lat, lon, country, state) {
  ...
  fetch(FORECAST_API_URL)
    ...
    .then((data) => {
      ...
      let forecasts = Object.values(dailyData).slice(0, 5);
...
locationBtn.addEventListener("click", getUserCoordinates); // ✅ FIXED THIS LINE
